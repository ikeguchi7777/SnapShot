...
public class CountDown : MonoBehaviour
{
    ...
    [SerializeField]
    GameObject[] count;
    float[] timepoint = {300,240,180,120, 60, 30, 10,  5,  4,  3,  2,  1,  0, -1};
    //float[] timepoint = {300,295,290,285,280,275,270,269,268,267,265,264,263, -1};
            ...
            if (mainGameManager.GetTimer() < timepoint[i] && mainGameManager.GetTimer() > timepoint[i+1])
            {
                ...
                if (flag == i)
                {
                    ...
                    else if (flag <= 11)
                    {
                        ...
                        seq.Join(count[i].GetComponent<Transform>().DOScale(new Vector2(1f, 1f), 0.2f));
